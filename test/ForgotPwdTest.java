...
//    }
    ...
    public void testSomeMethod1() throws Exception {
        ForgotPwdController controller=new ForgotPwdController(new ForgotpwdView());
        Boolean check=controller.checkQuestion(new ForgotPwdModel("admin","admin","admin","admin"));
    ...
    public void testSomeMethod2() throws Exception {
        ForgotPwdController controller=new ForgotPwdController(new ForgotpwdView());
        Boolean check=controller.checkPass(new ForgotPwdModel("admin","admin","admin","admin"));
