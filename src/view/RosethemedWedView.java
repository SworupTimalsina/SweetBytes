 ...
 * @author AduMan
 */
public class RosethemedWedView extends javax.swing.JFrame {

    /**
     * Creates new form RosethemedWedView
     */
    public RosethemedWedView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RosethemedWedView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RosethemedWedView().setVisible(true);
            }
        });
    }
