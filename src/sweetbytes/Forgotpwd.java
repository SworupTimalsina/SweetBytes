...
//        new Login().setVisible(true);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
             ...
             ResultSet rs= st.executeQuery("select securityQ from forgot_pwd where username='"+username+"'");
             if(rs.next()) {
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        try {
             ...
             Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/project_sb","root","Ranapurnima123$$");
             Statement st=conn.createStatement();
             ResultSet rs=st.executeQuery("select * from forgot_pwd where username='"+username+"' and answer='"+answer+"'");
             if(rs.next()) {
                 st.executeUpdate("update forgot_pwd set password='"+npassword+"' where username='"+username+"' and answer='"+answer+"'");
