 ...
 * @author AduMan
 */
public class SimpleBdayView extends javax.swing.JFrame {

    /**
     * Creates new form SimpleBdayView
     */
    public SimpleBdayView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimpleBdayView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SimpleBdayView().setVisible(true);
            }
        });
    }
