 ...
 * @author AduMan
 */
public class ExoticWedView extends javax.swing.JFrame {

    /**
     * Creates new form ExoticWedView
     */
    public ExoticWedView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExoticWedView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExoticWedView().setVisible(true);
            }
        });
    }
